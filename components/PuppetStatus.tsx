...
import type { Puppet, Component, Quest, Companion } from '../types';
...
type PuppetView = 'stats' | 'skills' | 'components' | 'mutations' | 'memories' | 'design' | 'inventory' | 'quests' | 'companions';
...
const PuppetStatus: React.FC<PuppetStatusProps> = ({ puppet, componentInventory, sideQuests, companions }) => {
                ...
                <div className="animate-fade-in">
                    <Section title="Mảnh Ký Ức">
                         <div className="space-y-2">
                            ...
                            )) : <p className="text-gray-500 italic text-center py-4">Chưa mở khóa ký ức nào.</p>}
                        </div>
                    </Section>
                </div>
            );
  ...
  return (
    <aside className="ui-panel p-4 h-full flex flex-col">
      ...
      <div className="grid grid-cols-4 lg:grid-cols-4 gap-1 mb-4 border-y border-red-500/20 py-2 flex-shrink-0">

...
export const DEFAULT_QUESTS = [
    {
        id: 'master-legacy',
        title: "Di Sản của Sư Phụ",
        description: "Sư phụ của tôi đã biến mất khi đang chế tạo 'Tâm Cơ Luân Nguyên Bản', một thiết bị có thể định hình lại thực tại. Tôi phải tìm ông ấy và hoàn thành công trình vĩ đại này trước khi nó rơi vào tay Cơ Giới Thần Giáo."
    },
    {
        id: 'cult-vengeance',
        title: "Sự Báo Thù",
        description: "Cơ Giới Thần Giáo đã cướp đi tất cả của tôi. Gia đình/bạn bè của tôi đã trở thành nạn nhân cho những thí nghiệm Tà Năng ghê tởm của chúng. Tôi sẽ săn lùng chúng, vạch trần tội ác của chúng và phá hủy giáo phái này từ bên trong."
    },
    {
        id: 'city-conspiracy',
        title: "Âm Mưu Đô Thị",
        description: "Một thế lực đen tối đang giật dây trong hội đồng thành phố, bí mật sử dụng công nghệ Tà Năng bị cấm để củng cố quyền lực. Tôi phải điều tra, thu thập bằng chứng và lật đổ những kẻ phản bội này trước khi chúng nhấn chìm thành phố trong hỗn loạn."
    },
];
